...
export const modificarContratoPorExpediente = async (req,res) => {
    ...
    try {
        const contrato = await contratoModel.findOneAndUpdate(expediente,{titulo,empresa,titularEmpresa,rolTitularEmpresa,firmaContrato,tipoContrato,ordenDeCompra,institutos,monto,duracion,fechaRegistro,numeroRegistro});
